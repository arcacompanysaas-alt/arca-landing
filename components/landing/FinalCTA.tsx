...
export default function FinalCTA({ isDark }: { isDark: boolean }) {
  return (
    <section className="relative w-full py-32 overflow-hidden px-12 z-20">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className={`text-xl mb-12 max-w-2xl mx-auto ${isDark ? 'text-gray-400' : 'text-gray-600'}`}
        >
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className={`relative overflow-hidden px-10 py-5 font-extrabold text-lg rounded-2xl transition-all duration-300 shadow-2xl ${
              isDark
          ...
          <motion.button
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            className={`px-10 py-5 font-bold text-lg rounded-2xl border transition-all ${
              isDark
